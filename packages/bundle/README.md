...
| [`personal-delivery`](personal-delivery/README.md) | Empty Personal Delivery patch carrier; it activates no provider, Queue bridge, Remote, or browser plugin | — (patch only) |
