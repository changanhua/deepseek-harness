...
export const en = {
  ...
  'view.map': 'System map',
  'view.directory': 'Package directory',
  'map.profiles': 'Profile templates',
  'map.bundles': 'Bundle layers',
  'map.packages': 'packages',
  'map.runtimeObserved': 'observed',
  'map.legend': 'Map evidence legend',
  'map.buildIncluded': 'Included in build',
  'map.activeDetail': 'Execution phase in detail',
