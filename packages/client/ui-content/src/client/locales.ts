...
export const zh = {
  ...
  'view.title': '内容库',
  'view.subtitle': '保存来自网页与会话的材料，并继续编辑。',
  'action.refresh': '刷新',
  'action.retry': '重试',
  ...
  'editor.bodyPlaceholder': '正文',
  'editor.saving': '正在保存…',
  'editor.committing': '正在提交…',
  'editor.conflict': '内容已被其他窗口修改。',
  'editor.conflict.hint': '保存或提交时使用了过期的版本；已重新读取最新内容，请选择保留哪一方。',
  'editor.conflict.local': '我的编辑',
  'editor.conflict.remote': '库里的当前内容',
  'editor.conflict.keepLocal': '保留我的编辑',
  'editor.conflict.useRemote': '采用库里的内容',
  'editor.commitDone': '已提交新版本',
  'editor.draftSaved': '草稿已保存',
  'status.opening': '内容库正在打开…',
  'status.unavailable': '内容库当前不可用',
  'status.closed': '内容库已关闭',
  'library.empty': '还没有捕获任何内容。',
  'library.emptyHint': '通过浏览器扩展发送材料，或在会话中点击“捕获到内容库”。',
  'entry.versions': '个版本',
  'entry.draft': '草稿编辑中',
  'entry.favorite': '收藏',
  'entry.archived': '已归档',
  ...
  'detail.source.unverified': '网页来源信息未经独立验证',
  'extension.title': '浏览器连接',
  'extension.pending': '正在读取或保存连接状态…',
  'extension.permission': '允许此扩展向当前 DSH 内容库发送材料。',
  'extension.identity': '扩展标识',
  'extension.allow': '允许发送到内容库',
  'extension.reject': '拒绝连接',
  'extension.approved': '已允许，请返回扩展继续。',
  'extension.rejected': '已拒绝此连接请求。',
  'extension.empty': '尚无已授权的浏览器连接。',
  'extension.revoke': '撤销连接',
  'extension.close': '关闭',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'view.subtitle': 'Materials saved from websites and sessions, with later edits.',
  ...
  'editor.committing': 'Committing…',
  'editor.conflict': 'This content changed in another window.',
  'editor.conflict.hint': 'A save or commit used a stale version; the latest content was re-read. Choose which side to keep.',
  'editor.conflict.local': 'My edit',
  'editor.conflict.remote': 'Current content in the library',
  'editor.conflict.keepLocal': 'Keep my edit',
  'editor.conflict.useRemote': 'Use library content',
  'editor.commitDone': 'Committed a new version',
  ...
  'library.emptyHint': 'Send material from the browser extension, or use "Capture to library" in a session.',
  'entry.versions': 'versions',
  'entry.draft': 'Draft in progress',
  'entry.favorite': 'Favorite',
  'entry.archived': 'Archived',
  'entry.kind.original': 'Session capture',
  'entry.kind.web': 'Web capture',
  'entry.kind.idea': 'Manual entry',
  'detail.body': 'Body',
  'detail.source': 'Source',
  'detail.source.session': 'Session message',
  'detail.source.provided': 'Entered manually',
  'detail.source.unverified': 'Website provenance has not been independently verified',
  'extension.title': 'Browser connections',
  'extension.pending': 'Reading or saving connection status…',
  'extension.permission': 'Allow this extension to send materials to this DSH content library.',
  'extension.identity': 'Extension identity',
  'extension.allow': 'Allow content imports',
  'extension.reject': 'Reject connection',
  'extension.approved': 'Access allowed. Return to the extension to continue.',
  'extension.rejected': 'This connection request was rejected.',
  'extension.empty': 'No browser connections are authorized.',
  'extension.revoke': 'Revoke connection',
