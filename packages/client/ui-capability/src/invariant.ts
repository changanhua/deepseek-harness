/**
 * Package-owned invariant companion for `@changanhua/dsh-client-ui-capability`.
 * @module @changanhua/dsh-client-ui-capability/invariant
 */
...
const PACKAGE_NAME = '@changanhua/dsh-client-ui-capability'
