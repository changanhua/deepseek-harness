...
The `/#settings=models` deep link opens the full settings panel on Models. Other registered sections use their section id; initial navigation waits for the settings shell to mount.
