...
| [`memory/`](memory/README.zh.md) | 项目范围内的命题、来源可用性与持久人工决策 |
...
| [`browser/`](browser/README.zh.md) | Session 寻址的浏览器操作、已认证 Chrome worker gateway 与 owner 批准的授权 |
...
| [`content/`](content/README.zh.md) | 个人保存文本、不可变版本与可编辑草稿 |
