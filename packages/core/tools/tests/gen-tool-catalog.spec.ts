...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'ask_user_question', 'bash', 'bash', 'browser_action', 'browser_action_sequence', 'browser_activity_search',
      'browser_entry_mount', 'browser_entry_unmount', 'browser_extract', 'browser_instances', 'browser_page_map',
      'browser_region_clear', 'browser_region_render', 'browser_request_status', 'browser_snapshot', 'browser_tabs',
      'browser_task_start', 'browser_task_verify', 'cordis_define', 'cordis_inspect_list',
      ...
      'knowledge_base', 'list_agents', 'list_agents', 'list_subagent_models', 'lsp',
      'memory_propose', 'memory_read', 'memory_search', 'operation_run_enqueue', 'operation_run_enqueue_batch',
      'present', 'pwsh', 'pwsh', 'ralph',
      'read', 'read_image', 'run_code', 'runtime_inspect', 'schedule_create', 'schedule_delete',
      ...
      'str_replace_editor', 'subagent', 'task_queue_cancel', 'task_queue_enqueue', 'task_queue_enqueue_batch',
      'task_queue_kinds', 'task_queue_list', 'task_queue_result', 'task_queue_retry', 'task_queue_stats', 'task_queue_status', 'team_task_create',
