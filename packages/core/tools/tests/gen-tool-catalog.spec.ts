...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'read', 'read_image', 'report', 'run_code', 'runtime_inspect', 'schedule_create', 'schedule_delete',
      ...
      'str_replace_editor', 'subagent', 'task_queue_cancel', 'task_queue_dismiss',
      'task_queue_enqueue', 'task_queue_enqueue_batch', 'task_queue_executors', 'task_queue_list',
      'task_queue_retry', 'task_queue_stats', 'task_queue_status', 'task_queue_undismiss',
      'team_task_create',
