/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-tool-operation-run-task-queue`.
 * @module @deepseek-ai/dsh-tool-operation-run-task-queue/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-tool-operation-run-task-queue'
