/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-task-queue-local`.
 * @module @deepseek-ai/dsh-task-queue-local/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-task-queue-local'
