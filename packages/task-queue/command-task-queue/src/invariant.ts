/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-command-task-queue`.
 * @module @deepseek-ai/dsh-command-task-queue/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-command-task-queue'
