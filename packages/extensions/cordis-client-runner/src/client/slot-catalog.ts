...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-skills SkillsSection',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-work-observatory WorkObservatoryWorkspace id \'work-observatory\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-work-observatory WorkObservatoryNavEntry id \'work-observatory-module\'',
    ],
    replaceRisk: 'none',
