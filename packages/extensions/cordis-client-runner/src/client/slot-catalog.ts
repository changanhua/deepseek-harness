...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      '@changanhua/dsh-client-ui-content CaptureAction id \'capture\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@changanhua/dsh-client-ui-settings-skills SkillsPopover id \'skills\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Downstream rightbar name retained as a wire-compatible alias.',
    doc: 'Downstream rightbar name retained as a wire-compatible alias.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    occupants: [
      ...
      '@changanhua/dsh-client-ui-settings-skills SkillsSection',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      '@changanhua/dsh-client-ui-content BrowserConnectionPanel id \'content-browser-connection\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      '@changanhua/dsh-client-ui-architecture ArchitectureWorkspace id \'architecture\'',
      '@changanhua/dsh-client-ui-capability CapabilityWorkspace id \'capability\'',
      '@changanhua/dsh-client-ui-content ContentLibraryWorkspace id \'content-library\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'The first-level Queue entry between the session browsing region and the foot.',
    doc: 'The first-level Queue entry between the session browsing region and the\nfoot. Declared by this package\'s \'sidebar\' entry; each entry receives\nthe column state plus the center module-ring state it can switch.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      '@changanhua/dsh-client-ui-task-queue QueueNavEntry id \'queue-module\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.modules.group',
    kind: 'list',
    scope: 'root',
    summary: 'Non-queue module entries shown inside the sidebar\'s collapsed More group.',
    doc: 'Non-queue module entries shown inside the sidebar\'s collapsed More group.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      '@changanhua/dsh-client-ui-architecture ArchitectureNavEntry id \'architecture-module\'',
      '@changanhua/dsh-client-ui-capability CapabilityNavEntry id \'capability-module\'',
      '@changanhua/dsh-client-ui-content ContentLibraryNavEntry id \'content-library-module\'',
      '@changanhua/dsh-client-ui-delivery DeliveryNavEntry id \'delivery-module\'',
      '@changanhua/dsh-client-ui-work-observatory WorkObservatoryNavEntry id \'work-observatory-module\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.modules.group\', () => ctx.slots.register(\n      { name: \'sidebar.modules.group\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
