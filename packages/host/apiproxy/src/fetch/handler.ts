...
import { skillManagementSnapshotRequestSchema } from '../api/skill-management.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'skillManagement.snapshot': { schema: skillManagementSnapshotRequestSchema, invoke: (api, r) => api.skillManagement.snapshot(r) },
