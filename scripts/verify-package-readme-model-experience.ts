...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/task-queue/task-queue-executor-dsh': { kind: 'indirect', reason: 'The executor supplies a semantic outcome adapter; dsh-tool-task-queue owns the model-facing schema, prompt guidance, and notification projection.' },
  'packages/task-queue/tool-task-queue': { kind: 'indirect', reason: 'The toolkit registers generic task_queue_* tools and stable Notification messages; explicit result reads own typed executor output.' },
  ...
  'packages/image/image-generation-arkcli': { kind: 'indirect', reason: 'The provider delegates model rendering to the Queue handler and admission tool.' },
  'packages/image/image-generation-task-queue': { kind: 'indirect', reason: 'The WorkHandler delegates model rendering to the image admission tool.' },
  ...
  'packages/memory/memory': { kind: 'none', reason: 'The memory Definition registers no tools or prompts; consumers own rendered results.' },
  'packages/memory/memory-local': { kind: 'none', reason: 'The local provider returns domain data; model-visible tools and human commands belong to consumers.' },
  'packages/memory/command-memory': { kind: 'none', reason: 'Human inspection and decisions return command results without a model turn.' },
  ...
  'packages/client/ui-capability': { kind: 'none', reason: 'Browser-side capability projection; loading a snapshot reads bounded host registries and registers no model surface.' },
  'packages/client/ui-architecture': { kind: 'none', reason: 'Browser-side architecture projection; catalog and Loader reads register no model surface.' },
  ...
  'packages/client/ui-settings-skills': { kind: 'none', reason: 'Browser-side read-only skills management UI; the managementSnapshot projection registers no model surface.' },
  'packages/client/ui-task-queue': { kind: 'none', reason: 'Browser-side queue panel rendering durable records; dsh-tool-task-queue owns the model-facing tools.' },
  ...
  'packages/host/capability-registry': { kind: 'none', reason: 'Host-only capability projection; registers no prompt, tool, message, or provider request.' },
  ...
  'packages/host/work-observatory': { kind: 'none', reason: 'This Host-only time evidence service registers no prompt, tool, message, or provider request.' },
  ...
  'packages/delivery/delivery-github-publisher': { kind: 'indirect', reason: 'The Host-only library delegates every browser or model-visible projection to Delivery Remote and UI consumers.' },
