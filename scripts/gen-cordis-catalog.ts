...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  planMode: 'plan.md',
  projectMemory: 'project-memory.md',
  ...
  runtimeFacts: 'runtime-facts.md',
  repoWorkspace: 'delivery.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsNavigator: 'client-side settings-navigator interface contract — packages/client/ui-settings/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  BrowserOperationContext: 'browser.md',
  BrowserDispatchContext: 'browser.md',
  BrowserDispatchDecision: 'browser.md',
  BrowserOperationSettlement: 'browser.md',
  ...
  BrowserRecoveryLocator: 'browser.md',
  BrowserRegionRef: 'browser.md',
  BrowserRegionPresentation: 'browser.md',
  BrowserActionDescription: 'browser.md',
  BrowserPreparedAction: 'browser.md',
  BrowserActionResult: 'browser.md',
  BrowserRequestStatus: 'browser.md',
  BrowserRequestStatusQuery: 'browser.md',
  BrowserTaskId: 'browser.md',
  BrowserTaskRef: 'browser.md',
  BrowserTaskPhase: 'browser.md',
  BrowserTaskOutcome: 'browser.md',
  BrowserTaskBlocker: 'browser.md',
  BrowserPage: 'browser.md',
  BrowserTargetBinding: 'browser.md',
  BrowserSessionTargetBinding: 'browser.md',
  BrowserSessionTargetState: 'browser.md',
  HandoffBrowserFunctionRequest: 'browser.md',
  BrowserTaskSourceRef: 'browser.md',
  BrowserTaskEvidence: 'browser.md',
  AcceptanceClause: 'browser.md',
  AcceptanceEvaluation: 'browser.md',
  BrowserActionAttempt: 'browser.md',
  BrowserPageResource: 'browser.md',
  BrowserCapability: 'browser.md',
  DelegatedWorkRef: 'browser.md',
  BrowserTaskBudget: 'browser.md',
  BrowserTaskSnapshot: 'browser.md',
  BrowserTaskReceipt: 'browser.md',
  BrowserTaskCheck: 'browser.md',
  CreateBrowserTaskRequest: 'browser.md',
  ...
  RuntimeFact: 'runtime-facts.md',
  RuntimeFactContext: 'runtime-facts.md',
  ...
  BeginDispatchRequest: 'delivery.md',
  BindDispatchRequest: 'delivery.md',
  BoundDeliveryEvidenceWriter: 'delivery.md',
  ChangeWorkspaceLease: 'delivery.md',
  ContractRevision: 'delivery.md',
  ContractRevisionId: 'delivery.md',
  CompleteIssuePublicationRequest: 'delivery.md',
  CreateDeliveryCaseRequest: 'delivery.md',
  CreateWorkPacketRequest: 'delivery.md',
  DeliveryCase: 'delivery.md',
  DeliveryCaseId: 'delivery.md',
  DeliverySnapshot: 'delivery.md',
  DispatchBinding: 'delivery.md',
  DispatchBindingId: 'delivery.md',
  EvidenceId: 'delivery.md',
  EvidenceRef: 'delivery.md',
  FailIssuePublicationRequest: 'delivery.md',
  InspectRepositoryRangeRequest: 'delivery.md',
  InspectRepositoryRevisionRequest: 'delivery.md',
  OpenChangeWorkspaceRequest: 'delivery.md',
  OpenVerificationWorkspaceRequest: 'delivery.md',
  IssuePublication: 'delivery.md',
  IssuePublicationId: 'delivery.md',
  PrepareIssuePublicationRequest: 'delivery.md',
  RecordAcceptanceDecisionRequest: 'delivery.md',
  RecordRequirementDecisionRequest: 'delivery.md',
  ReadRepositoryBlobRequest: 'delivery.md',
  RepositoryRangeFacts: 'delivery.md',
  ResolveRepositoryBaseRequest: 'delivery.md',
  ResolveIssuePublicationRequest: 'delivery.md',
  RequirementDecision: 'delivery.md',
  RequirementDecisionId: 'delivery.md',
  ReviseDeliveryCaseRequest: 'delivery.md',
  SaveDeliveryEvidence: 'delivery.md',
  StoredDeliveryEvidence: 'delivery.md',
  VerificationSourceResolver: 'delivery.md',
  VerificationWorkspaceLease: 'delivery.md',
  VerifiedRepositoryBase: 'delivery.md',
  VerifiedRepositoryBlob: 'delivery.md',
  VerifiedRepositoryRevision: 'delivery.md',
  WorkPacket: 'delivery.md',
  WorkPacketId: 'delivery.md',
  ...
  PreparedStage: 'knowledge.md',
  WorkView: 'task-queue.md',
  ...
  SkillManagementResult: 'skills.md',
  ...
  MemorySearchRequest: 'project-memory.md',
  MemorySearchResult: 'project-memory.md',
  MemoryReadResult: 'project-memory.md',
  MemoryProposal: 'project-memory.md',
  MemoryMutation: 'project-memory.md',
  MemoryDecisionRequest: 'project-memory.md',
  MemoryInspectionRequest: 'project-memory.md',
  MemoryInspectedRecord: 'project-memory.md',
  ...
  ResourceId: 'workspace.md',
  ResourceInput: 'workspace.md',
  ResourceView: 'workspace.md',
  ResourceFile: 'workspace.md',
  ResourceList: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TaskStatus: 'task-queue lifecycle vocabulary is owned by packages/task-queue/task-queue/README.md',
  EnqueueSpec: 'task-queue admission vocabulary is owned by packages/task-queue/task-queue/README.md',
  ListFilter: 'task-queue filter vocabulary is owned by packages/task-queue/task-queue/README.md',
  TaskSummary: 'task-queue projection vocabulary is owned by packages/task-queue/task-queue/README.md',
  Task: 'task-queue task model is owned by packages/task-queue/task-queue/README.md',
  ...
  FoldedQueue: 'task-queue fold vocabulary is owned by packages/task-queue/task-queue/README.md',
  ServiceState: 'task-queue service vocabulary is owned by packages/task-queue/task-queue/README.md',
  ...
  DynamicCordisInstallationOwner: 'delivered function ownership is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionHandoff: 'delivered function handoff is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionHandoffReceipt: 'delivered function handoff is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionHandoffRequest: 'delivered function handoff is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionStopRequest: 'delivered function command is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionCommandReceipt: 'delivered function command is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionCommandStatus: 'delivered function command progress is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionRunRequest: 'delivered function command is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisFunctionEditRequest: 'delivered function command is owned by packages/extensions/cordis-host-runner/src/types.ts',
  DynamicCordisPreparedEditReceipt: 'delivered function edit admission is owned by packages/extensions/cordis-host-runner/src/types.ts',
  ...
  WorkspaceFileScope: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
  ...
  AdmittedPromptContentPart: 'attachment admission contract is owned by packages/attachment/attachment/README.md',
  AttachmentAdmissionPart: 'attachment admission contract is owned by packages/attachment/attachment/README.md',
  EncodedFileAttachment: 'file attachment contract is owned by packages/attachment/attachment/README.md',
  FileAttachmentRef: 'file attachment contract is owned by packages/attachment/attachment/README.md',
  SaveFileAttachment: 'file attachment contract is owned by packages/attachment/attachment/README.md',
  SaveFileStreamAttachment: 'file attachment contract is owned by packages/attachment/attachment/README.md',
  AttachmentError: 'attachment error contract is owned by packages/attachment/attachment/README.md',
  AgentResolver: 'file upload resolver contract is owned by packages/client/file-upload/README.md',
  EncodedFileUploadRequest: 'file upload request contract is owned by packages/client/file-upload/README.md',
  FileUploadValue: 'file upload result contract is owned by packages/client/file-upload/README.md',
  FileUploadReceiptId: 'file upload identity is owned by packages/client/file-upload/README.md',
  PromptFileBinding: 'file upload prompt binding is owned by packages/client/file-upload/README.md',
  SessionFeedbackRecordRequest: 'session feedback contract is owned by packages/feedback/command-feedback/README.md',
  SessionFeedbackRecordResult: 'session feedback contract is owned by packages/feedback/command-feedback/README.md',
  CommandFileReceiptResolver: 'command attachment resolver contract is owned by packages/interaction/commands/README.md',
  CommandSubmitAttachment: 'command attachment contract is owned by packages/interaction/commands/README.md',
  SessionLogOffset: 'session log offset contract is owned by packages/core/session/README.md',
  SessionSeq: 'session sequence contract is owned by packages/core/session/README.md',
  SessionHandle: 'session persistence handle is owned by packages/session/session-persistence/README.md',
  SessionAccess: 'session persistence access is owned by packages/session/session-persistence/README.md',
  SessionPersistenceCreateOptions: 'session persistence options are owned by packages/session/session-persistence/README.md',
  SessionPersistenceOpenOptions: 'session persistence options are owned by packages/session/session-persistence/README.md',
  SessionPersistenceStatOptions: 'session persistence options are owned by packages/session/session-persistence/README.md',
  SessionPersistenceListOptions: 'session persistence options are owned by packages/session/session-persistence/README.md',
  SettingsNamespaceInput: 'settings namespace input is owned by packages/settings/settings/README.md',
  SettingsSectionHooks: 'settings section hooks are owned by packages/settings/settings/README.md',
  SubagentSendMessageOptions: 'subagent message options are owned by packages/subagent/subagent/README.md',
  PromptSectionOrderName: 'system prompt section order is owned by packages/core/system-prompt/README.md',
  PromptContextOrderName: 'system prompt context order is owned by packages/core/system-prompt/README.md',
}
