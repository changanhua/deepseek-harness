...
| Page | Owns |
|---|---|
| [browser.md](browser.md) | authorized Chrome installations, explicit page and element references, bounded operations, and unknown-result recovery |
...
| [work-observatory.md](work-observatory.md) | Host-clock browser activity, Session-step wall-time evidence, bounded retention, interval normalization, and the dedicated user workspace |
...
| [knowledge.md](knowledge.md) | source-grounded editable knowledge libraries, durable stages, review identities, and immutable releases |
...
| [content.md](content.md) | personal content: original text, immutable versions, drafts and committed receipts |
...
| [project-memory.md](project-memory.md) | project claims, immutable revisions, source eligibility, and human acceptance |
