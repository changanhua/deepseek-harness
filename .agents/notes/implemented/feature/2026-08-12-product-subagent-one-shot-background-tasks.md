...
The downstream Web standard preset exposes Codex directly under the [Web standard delegation decision](2026-09-07-web-standard-codex-delegation.md); the one-shot foreground and Job semantics remain the same.
