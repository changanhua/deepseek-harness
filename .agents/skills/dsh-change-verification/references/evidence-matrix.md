...
| --- | --- | --- | --- | --- |
| Design draft or Skill instructions only | Artifact structure, provenance and semantic review; applicable metadata/links | Read the complete scoped artifact; validate its format; forward-test materially changed Skill routing | A maintained corpus, executable helper, generated surface, or runtime contract actually changes | Repository build as proof of a design; metadata or exact-word matching as proof of Skill decisions |
