...
interface ToolArgsMap {
  ...
  runtime_inspect: {
    /** Inspect registered runtime facts, or resolve one executable through the active subprocess provider. */
    kind: "facts" | "command";
    /** Runtime fact keys to inspect. Omit to inspect every currently registered fact. */
    keys?: string[];
    /** Absolute executable path or bare command name to resolve in the active execution world. */
    command?: string;
  };
